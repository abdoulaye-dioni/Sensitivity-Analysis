...
formula_x1 <- "~ x2"
para_x1 <- matrix(c(rep(1,3),rep(2.5,3), rep(1,3), rep(2,3),rep(1,3) ),ncol = 5)


formula_y <- "~ x1 + x2 "
betas <- c(-1, 1, -1, -1.5,-2, 2,  1, 2)
```
...
```{r}
manydelta <- data.frame( delta1 = c(0,0,0,0), delta2 = c(-3,1,0,0), delta3 = c(-3,1,0,1))
manydelta 
```
